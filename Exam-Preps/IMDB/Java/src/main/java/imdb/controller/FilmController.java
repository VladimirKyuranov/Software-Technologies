...
public class FilmController {
	...
	public String createProcess(Model model, FilmBindingModel filmBindingModel) {
		...
		this.filmRepository.saveAndFlush(cat);
	...
	@PostMapping("/edit/{id}")
	public String editProcess(@PathVariable int id, Model model, FilmBindingModel filmBindingModel) {
	...
	public String deleteProcess(@PathVariable int id, FilmBindingModel filmBindingModel) {
